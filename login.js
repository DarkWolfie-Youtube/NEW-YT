...
function DarkWolfieTube() {
  var email_submitted = document.getElementById('email').value
var password_subbmitted = document.getElementById("pass").value
  signInWithEmailAndPassword(auth, email_submitted, password_subbmitted)
  .then((userCredential) => {
    // Signed in 
    ...
    window.location.assign("auth?user=" + user_id )
    // ...
  })
  .catch((error) => {
